...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SimpleFreezedCopyWith<SimpleFreezed> get copyWith => _$SimpleFreezedCopyWithImpl<SimpleFreezed>(this as SimpleFreezed, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SimpleFreezed&&(identical(other.a, a) || other.a == a));
}
...
abstract mixin class $SimpleFreezedCopyWith<$Res>  {
  factory $SimpleFreezedCopyWith(SimpleFreezed value, $Res Function(SimpleFreezed) _then) = _$SimpleFreezedCopyWithImpl;
@useResult
$Res call({
 int a
});
