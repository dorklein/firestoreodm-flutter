  ...
  group('QueryReference', () {
    ...
    group('root query', () {
      test('overrides ==', () {
        ...
        expect(MovieCollectionReference().limit(1), isNot(MovieCollectionReference().limit(2)));
    ...
    test(
      ...
      () async {
        ...
        await ref.add(DocumentReferenceQuery(FirebaseFirestore.instance.doc('foo/a')));
        await ref.add(DocumentReferenceQuery(FirebaseFirestore.instance.doc('foo/b')));
        await ref.add(DocumentReferenceQuery(FirebaseFirestore.instance.doc('foo/c')));
        ...
        expect(snapshot.docs[0].data.ref, FirebaseFirestore.instance.doc('foo/b'));
        expect(snapshot.docs[1].data.ref, FirebaseFirestore.instance.doc('foo/c'));
      },
